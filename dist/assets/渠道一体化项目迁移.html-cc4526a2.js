import{_ as n,o as s,c as a,d as t}from"./app-8b6d79d9.js";const e={},l=t(`<h1 id="渠道一体化项目迁移" tabindex="-1"><a class="header-anchor" href="#渠道一体化项目迁移" aria-hidden="true">#</a> 渠道一体化项目迁移</h1><p>开发周期1：20230807-20230821</p><p>开发周期2：20230904-20230915</p><p>项目概述：后台管理平台，经典组合技术栈（vue2+elementui）</p><p>难度：⭐⭐</p><p>繁琐程度：⭐⭐</p><p>相关知识点：</p><ul><li>在不修改表格数据的情况下使用插槽修改表格展示数据</li><li>下拉框的配置项以及数据源配置</li><li><code>vue.filer</code> (过滤器)</li><li>elementui上传组件的用法</li><li>clonedeep是个啥</li><li>使用插槽修改表格</li><li>路由传参query和params的区别</li><li>0914-less和scss的样式穿透用法区别</li><li>0914-项目的目录结构</li><li>0914-后端的数据库（dbServer Navicat...)区别</li><li></li></ul><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code>        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span> <span class="token attr-name">#isdisable</span><span class="token punctuation">&gt;</span></span>
        ...
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>template</span><span class="token punctuation">&gt;</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="插槽" tabindex="-1"><a class="header-anchor" href="#插槽" aria-hidden="true">#</a> 插槽</h2><p>复习一下插槽是什么</p><p>是什么：用于灵活修改组件的一个东西</p><p>分类：</p><ul><li>默认插槽</li><li>具名插槽</li><li>作用域插槽</li></ul><p>20230906</p><p>又是用到插槽的一天，很多东西不知道原理但是知道怎么用就很神奇，先模仿再超越，优秀开发者的第一步</p><h2 id="_20230914" tabindex="-1"><a class="header-anchor" href="#_20230914" aria-hidden="true">#</a> 20230914</h2><h3 id="manage-template" tabindex="-1"><a class="header-anchor" href="#manage-template" aria-hidden="true">#</a> Manage-template</h3><p>开发者须知：</p><ol><li>接口文件分模块命名存放在src/api/separate中</li><li>同样，组件也分模块存放： <ol><li>src/components/common则存放全局通用组件</li><li>src/components/separate则存放局部模块组件（建议每个模块另创建文件夹存放）</li></ol></li></ol><p>目录结构：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>│  <span class="token punctuation">.</span>browserslistrc
...
└─src
    ...
    └─views
        ...
        │
        └─pages                  # 存放项目所需要的页面
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="elementui-之【el-table】的魔改" tabindex="-1"><a class="header-anchor" href="#elementui-之【el-table】的魔改" aria-hidden="true">#</a> elementui 之【el-table】的魔改</h3><ul><li><p>表格显示多选框的状态下实现表格数据的单选</p></li><li><p>表头的全选框隐藏</p></li><li><p>效果图</p></li><li><p>实现代码</p></li></ul><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>Table</span> <span class="token attr-name">ref</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>tagTable<span class="token punctuation">&quot;</span></span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="css-预处理器" tabindex="-1"><a class="header-anchor" href="#css-预处理器" aria-hidden="true">#</a> CSS 预处理器</h2><ul><li>scss/sass</li><li>less</li><li>stylus</li></ul><table><thead><tr><th></th><th>语法</th><th>特点</th><th>是否支持变量</th><th>定义变量的方法</th><th>样式穿透用法</th></tr></thead><tbody><tr><td>sass</td><td>#container<br>width:100px</td><td>严格的语法缩进，不需要{}和；</td><td>✔️️</td><td>$container-color:red<br>.container<br><br>background-color:$container-color</td><td>::deep</td></tr><tr><td>scss</td><td>#container{<br> width:100px;<br>}</td><td>sass的升级版</td><td>✔️</td><td>$container-color:red<br>.container<br><br>background-color:$container-color</td><td>::deep</td></tr><tr><td>less</td><td></td><td>与css写法接近，使用{}和；</td><td>✔️</td><td>@container-color:red<br>.container<br><br>background-color:@container-color</td><td>/deep/</td></tr><tr><td>stylus</td><td></td><td></td><td>❌</td><td></td><td></td></tr><tr><td>css</td><td></td><td></td><td>❌</td><td></td><td>&gt;&gt;&gt;</td></tr></tbody></table>`,28),i=[l];function p(c,o){return s(),a("div",null,i)}const d=n(e,[["render",p],["__file","渠道一体化项目迁移.html.vue"]]);export{d as default};
