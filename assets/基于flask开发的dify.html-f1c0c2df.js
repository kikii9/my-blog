import{_ as e,o as i,c as n,a as s}from"./app-1f20ff92.js";const d={},l=s(`<p>目标：</p><p>1.工具的表的用途</p><p>2.表设计关系</p><p>3.口子的工具设计</p><div class="language-plaintext line-numbers-mode" data-ext="plaintext"><pre class="language-plaintext"><code>api/
├── .idea/             # IDE 配置文件
├── .vscode/           # VSCode 配置文件
├── configs/           # 配置文件目录
│   ├── __init__.py
